...
export default function MobileSearchBar(props: MobileSearchBarProps) {
  ...
  return (
    <>
      <header className="container-fluid shadow-sm d-block d-md-none sticky-top bg-white rounded-bottom-4 py-2 text-center header-responsive">
      ...
      <div
        ...
        id="busquedaServicioModal"
        tabIndex={-1}
        aria-labelledby="busquedaServicioModalLabel"
        aria-hidden="true"
      >
